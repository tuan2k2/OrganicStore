            ...
            <div class="inbox_msg">
                <div class="inbox_people">
                    ...
                    <div class="inbox_chat cursor-pointer" id="connect">
                        ...
                        <div class="chat_list cursor-pointer" data-id="{{$user->idKH}}" data-img="url">
        ...
        $('.chat_list').on('click', function(event) {
            ...
            if (!ownerId || ownerId != $(this).data('id')) {
                ...
                channel.bind('log-message', function(data) {
                    ...
                    var adminIdNow = "{{ Session::get('admin_id') }}";
                    console.log('ad id', adminIdNow);
                    if (data.from != adminIdNow) {
